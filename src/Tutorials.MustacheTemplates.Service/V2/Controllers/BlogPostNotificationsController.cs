...
using Tutorials.MustacheTemplates.Service.V2.ResourceModels;

namespace Tutorials.MustacheTemplates.Service.V2.Controllers
{
    [Route("api/v2/blog-post-notifications")]
    [ApiController]
#if VERSIONEDSWAGGER
    [ApiVersion("2.0")]
#endif
